...
}:
{
  ...
  "@types/three@0.185.1" = fetchurl {
    url = "https://registry.npmjs.org/@types/three/-/three-0.185.1.tgz";
    hash = "sha512-db1xTb+EgYF2didW+eudSvVPtn75zo+fGsY8ShQrJY/B5ZBmC2Fiaykv3aImHAlCNEGuMPkPGXBJGLwzu5mC7A==";
  };
