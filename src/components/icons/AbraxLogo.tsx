...
// cian→violeta→magenta; fuente: kit/logo/abrax-lockup.svg de la raíz de
// orquestación). Las letras y el núcleo usan currentColor para adaptarse a
// tema claro/oscuro; el glifo y la X conservan el degradado de marca.
const AbraxLogo = ({
  width,
  height,
  className,
