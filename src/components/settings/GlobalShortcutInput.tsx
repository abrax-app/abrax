      ...
      <div className="flex items-center space-x-1">
        {editingShortcutId === shortcutId ? (
          <div
            ...
            className="atajo-tecla grabando px-2 py-1 text-sm font-semibold border border-logo-primary bg-logo-primary/30 rounded-md"
          >
            {formatCurrentKeys()}
          </div>
        ) : (
          <div
            className="atajo-tecla px-2 py-1 text-sm font-semibold bg-mid-gray/10 border border-mid-gray/80 hover:bg-logo-primary/10 rounded-md cursor-pointer hover:border-logo-primary"
